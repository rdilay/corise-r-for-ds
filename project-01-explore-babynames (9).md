...
tbl_names_popular |> 
  ...
  labs(
    title = 'Top 5 Popular US Baby Names of Female(F) and Male(M)',
    subtitle = 'Year 2011 to 2020',
...
tbl_names_by_letter |> 
  ...
  labs(
    title = 'Popular Letters in US Baby Names',
    subtitle = 'Year 2020',
    x = 'First Letter on Name',
    y = 'Percentage of Birth'
  )
